if (typeof jQuery !== "undefined" && typeof saveAs !== "undefined") {
    (function($) {
        $.fn.wordExport = function(fileName,isbase64=false) {
            ...
            var styles = ".table-product{position: absolute;top: 18px; left: 565px;width: 400px; height: 195px; border: #aaa solid 1px; overflow-y: auto; max-height:195px; font-size:13px;}" +
